...
public class EnchantedGoldenAppleCow extends GoldenAppleCow implements SkinOverlayOwner {
    ...
    public boolean isBreedingItem(@NotNull ItemStack stack) {
        return stack.isOf(ItemInit.ENCHANTED_GOLDEN_WHEAT);
    }
    ...
    public ActionResult interactMob(@NotNull PlayerEntity player, Hand hand) {
        ...
        if (itemStack.isOf(Items.BUCKET) && !this.isBaby()) {
            ...
            ItemStack itemStack2 = ItemUsage.exchangeStack(itemStack, player, ItemInit.ENCHANTED_GOLDEN_MILK.getDefaultStack());
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(3, new TemptGoal(this, 1.25D, Ingredient.ofItems(ItemInit.ENCHANTED_GOLDEN_WHEAT), false));
