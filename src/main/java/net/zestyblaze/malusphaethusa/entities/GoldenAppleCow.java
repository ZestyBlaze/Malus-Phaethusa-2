...
public class GoldenAppleCow extends AppleCow implements SkinOverlayOwner {
    ...
    public boolean isBreedingItem(@NotNull ItemStack stack) {
        return stack.isOf(ItemInit.GOLDEN_WHEAT);
    }
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(3, new TemptGoal(this, 1.25D, Ingredient.ofItems(ItemInit.GOLDEN_WHEAT), false));
    ...
    public ActionResult interactMob(@NotNull PlayerEntity player, Hand hand) {
        ...
        if (itemStack.isOf(Items.BUCKET) && !this.isBaby()) {
            ...
            ItemStack itemStack2 = ItemUsage.exchangeStack(itemStack, player, ItemInit.GOLDEN_MILK.getDefaultStack());
