...
public class ClientInit {
    ...
    public static void register() {
        EntityRendererRegistry.register(EntityInit.APPLE_COW, AppleCowEntityRenderer::new);
        EntityRendererRegistry.register(EntityInit.GOLDEN_APPLE_COW, GoldenAppleCowEntityRenderer::new);
        EntityRendererRegistry.register(EntityInit.ENCHANTED_GOLDEN_APPLE_COW, EnchantedGoldenAppleCowEntityRenderer::new);
